...
RUN wget --no-check-certificate 'https://drive.google.com/uc?export=download&id=1LxcbCHDCYllYD78EAC2ScBnDOhu7ip4s' -O IoTData.zip
...
RUN git clone --depth 1 https://github.com/152269205-myseneca/raspberrypi.git
